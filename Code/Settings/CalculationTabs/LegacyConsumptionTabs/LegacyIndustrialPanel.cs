// <copyright file="LegacyIndustrialPanel.cs" company="algernon (K. Algernon A. Sheppard)">
...
namespace RealPop2
{
    ...
    internal class LegacyIndustrialPanel : LegacyPanelBase
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="LegacyIndustrialPanel"/> class.
        /// </summary>
        /// <param name="tabStrip">Tab strip to add to.</param>
        /// <param name="tabIndex">Index number of tab.</param>
        internal LegacyIndustrialPanel(UITabstrip tabStrip, int tabIndex)
