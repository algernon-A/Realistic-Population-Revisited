...
namespace RealPop2
{
    ...
    public static class GoodsUtils
    {
        ...
        private static int s_w2wComMult = DefaultSalesMult;
        ...
        private static int s_w2wComInv = DefaultInventory;
